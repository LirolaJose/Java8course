...
public class MonadLaws {
    ...
    private static Function<Integer, Optional<Integer>> function = integer -> Optional.of(integer * 2);
    private static Function<Integer, Optional<Integer>> optionalOf = Optional::of;

    private static Function<Integer, Optional<Integer>> g = optionalOf;
    private static Function<Integer, Optional<Integer>> function_flatMap_g = integer -> g.apply(integer).flatMap(function);
